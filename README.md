...
После ввода своих данных на почту прийдет писмьмо для подтверджения. Необходимо перейти по ссылке, указанной в письме.
...
После авторизации отобразится интерфейс, который зависит от того, кем является авторизоанный пользователь. 
...
2. Для менеджера, который управвляет поьзоателями и их рассылками
